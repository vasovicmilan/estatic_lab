...
export async function updateUserStatus(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), success: false, errorMessage: error.message, action: "USER_STATUS_CHANGED", entity: { type: "User", id: req.params.userId } });
    next(error);
  }
}
...
export async function updateUserRole(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), success: false, errorMessage: error.message, action: "USER_ROLE_CHANGED", entity: { type: "User", id: req.params.userId } });
    next(error);
  }
}
...
export async function verifyUser(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), action: "USER_VERIFIED_BY_ADMIN", entity: { type: "User", id: userId } });
...
export async function updateEmployee(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), action: "EMPLOYEE_UPDATED", entity: { type: "Employee", id: employeeId }, changes });
...
export async function updateEmployeeWorkingHours(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), action: "EMPLOYEE_WORKING_HOURS_UPDATED", entity: { type: "Employee", id: employeeId } });
...
export async function createExpert(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), action: "EXPERT_CREATED", entity: { type: "Expert", id: expert.id } });
...
export async function updateExpert(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), action: "EXPERT_UPDATED", entity: { type: "Expert", id: expertId } });
    return res.json({ success: true, data: expert });
  } catch (error) {
...
export async function deleteExpert(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), action: "EXPERT_DELETED", entity: { type: "Expert", id: expertId } });
...
export async function createPartner(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), action: "PARTNER_CREATED", entity: { type: "Partner", id: partner.id } });
...
export async function updatePartner(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), action: "PARTNER_UPDATED", entity: { type: "Partner", id: partnerId } });
    return res.json({ success: true, data: partner });
  } catch (error) {
...
export async function deletePartner(req, res, next) {
  try {
    ...
    await auditLogService.recordAuditLog({ ...auditActor(req), action: "PARTNER_DELETED", entity: { type: "Partner", id: partnerId } });
