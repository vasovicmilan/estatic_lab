...
// (system time UTC). appointment.filter.js's dateTo is an EXCLUSIVE `$lt`
// bound, so dateTo needs to become the start of the NEXT Belgrade day, not
// just that day's own midnight - see date.time.util.js.
