...
export function prepareUserEditFormData(user) {
  return {
    formAction: `/admin/korisnici/${user.id}`,
    isEdit: true,
    fields: [
    ...
    cancelUrl: `/admin/korisnici/detalji/${user.id}`,
    breadcrumbs: [
      { label: "Admin", url: "/admin" },
      { label: "Korisnici", url: "/admin/korisnici" },
      { label: user.imePrezime, url: `/admin/korisnici/detalji/${user.id}` },
